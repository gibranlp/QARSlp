...
Soon all the development of QARSlp will be moving to [SpectrumOS](https://github.com/gibranlp/SpectrumOS), as the project moves forward, please go and check it out!.
