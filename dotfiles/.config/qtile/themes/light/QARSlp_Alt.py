...
def init_widgets_list():
    widgets_list = [
            ...
            widget.Prompt(
              ...
              cursor_secondary_color=secondary_color[4],
              visual_bell_secondary_color=[4],
            ...
            widget.GroupBox(
              ...
              block_highlight_text_secondary_color=secondary_color[2],    
            ...
            widget.ALSAWidget(
              decorations=[RectDecoration(colour=secondary_color[0], radius=0, filled=True)],
              device='Master',
              bar_colour_high=secondary_color[2],
              bar_colour_loud=secondary_color[2],
              bar_colour_normal=secondary_color[2],
              bar_colour_mute=secondary_color[2],
              hide_interval=5,
              update_interval=0.1,
              bar_width=80,
              mode='bar',
