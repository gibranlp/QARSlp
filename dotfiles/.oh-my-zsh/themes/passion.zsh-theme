...
# git
ZSH_THEME_GIT_PROMPT_PREFIX="%{$fg_no_bold[blue]%} %{$fg_no_bold[red]%}  (%{$fg_no_bold[yellow]%}";
...
function update_command_status() {
    ...
    if $COMMAND_RESULT;
    then
        arrow="%{$fg_bold[blue]%}⮕%{$fg_bold[green]%}%{$fg_bold[blue]%}⮕%{$fg_bold[red]%}%{$fg_bold[blue]%}⮕%{$fg_bold[yellow]%}";
    else
        arrow="%{$fg_bold[red]%}⮕⮕⮕";
    fi
